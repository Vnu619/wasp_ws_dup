...
"""autogenerated by genpy from wasp_logistics/TrolleyAlignAction.msg. Do not edit."""
import codecs
import sys
...
class TrolleyAlignAction(genpy.Message):
  _md5sum = "eb405d1b003d2e3fea8235fda166bb1c"
  _type = "wasp_logistics/TrolleyAlignAction"
...
"""
  ...
  _slot_types = ['wasp_logistics/TrolleyAlignActionGoal','wasp_logistics/TrolleyAlignActionResult','wasp_logistics/TrolleyAlignActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrolleyAlignAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = wasp_logistics.msg.TrolleyAlignActionGoal()
      if self.action_result is None:
        self.action_result = wasp_logistics.msg.TrolleyAlignActionResult()
      if self.action_feedback is None:
        self.action_feedback = wasp_logistics.msg.TrolleyAlignActionFeedback()
    else:
      self.action_goal = wasp_logistics.msg.TrolleyAlignActionGoal()
      self.action_result = wasp_logistics.msg.TrolleyAlignActionResult()
      self.action_feedback = wasp_logistics.msg.TrolleyAlignActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_goal.goal.align, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.align_distance
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.align, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      self.action_goal.goal.align = bool(self.action_goal.goal.align)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.align_distance,) = _get_struct_f().unpack(str[start:end])
      return self
