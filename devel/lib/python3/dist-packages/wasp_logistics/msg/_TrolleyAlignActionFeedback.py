...
"""autogenerated by genpy from wasp_logistics/TrolleyAlignActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TrolleyAlignActionFeedback(genpy.Message):
  _md5sum = "595dc001f3661156362f944e10f1e5f3"
  _type = "wasp_logistics/TrolleyAlignActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','wasp_logistics/TrolleyAlignFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrolleyAlignActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = wasp_logistics.msg.TrolleyAlignFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = wasp_logistics.msg.TrolleyAlignFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.align_distance
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.align_distance,) = _get_struct_f().unpack(str[start:end])
      return self
