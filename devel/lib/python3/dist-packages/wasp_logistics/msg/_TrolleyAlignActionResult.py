...
"""autogenerated by genpy from wasp_logistics/TrolleyAlignActionResult.msg. Do not edit."""
import codecs
import sys
...
class TrolleyAlignActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "wasp_logistics/TrolleyAlignActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','wasp_logistics/TrolleyAlignResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrolleyAlignActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = wasp_logistics.msg.TrolleyAlignResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = wasp_logistics.msg.TrolleyAlignResult()
