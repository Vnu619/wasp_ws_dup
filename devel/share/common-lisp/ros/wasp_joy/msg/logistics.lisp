...
(cl:defmethod cl:initialize-instance :after ((m <logistics>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'logistics)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wasp_joy-msg:<logistics> is deprecated: use wasp_joy-msg:logistics instead.")))

(cl:ensure-generic-function 'liftup-val :lambda-list '(m))
(cl:defmethod liftup-val ((m <logistics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wasp_joy-msg:liftup-val is deprecated.  Use wasp_joy-msg:liftup instead.")
  (liftup m))

(cl:ensure-generic-function 'liftdown-val :lambda-list '(m))
(cl:defmethod liftdown-val ((m <logistics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wasp_joy-msg:liftdown-val is deprecated.  Use wasp_joy-msg:liftdown instead.")
  (liftdown m))

(cl:ensure-generic-function 'lifthome-val :lambda-list '(m))
(cl:defmethod lifthome-val ((m <logistics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wasp_joy-msg:lifthome-val is deprecated.  Use wasp_joy-msg:lifthome instead.")
  (lifthome m))

(cl:ensure-generic-function 'extrude-val :lambda-list '(m))
(cl:defmethod extrude-val ((m <logistics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wasp_joy-msg:extrude-val is deprecated.  Use wasp_joy-msg:extrude instead.")
  (extrude m))

(cl:ensure-generic-function 'intrude-val :lambda-list '(m))
(cl:defmethod intrude-val ((m <logistics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wasp_joy-msg:intrude-val is deprecated.  Use wasp_joy-msg:intrude instead.")
  (intrude m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <logistics>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'liftdown))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'lifthome))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <logistics>) istream)
  "Deserializes a message object of type '<logistics>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'lifthome) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<logistics>)))
  ...
  "cab0a4435034735f1a142bf0d06c3d35")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'logistics)))
  "Returns md5sum for a message object of type 'logistics"
  "cab0a4435034735f1a142bf0d06c3d35")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<logistics>)))
  ...
  (cl:format cl:nil "float64 liftup~%float64 liftdown~%float64 lifthome~%float64 extrude~%float64 intrude~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'logistics)))
  "Returns full string definition for message of type 'logistics"
  (cl:format cl:nil "float64 liftup~%float64 liftdown~%float64 lifthome~%float64 extrude~%float64 intrude~%~%~%"))
