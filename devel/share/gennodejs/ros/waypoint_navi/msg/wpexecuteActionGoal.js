...
let wpexecuteGoal = require('./wpexecuteGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class wpexecuteActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = wpexecuteGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new wpexecuteActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = wpexecuteGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new wpexecuteGoal()
    }
...
module.exports = wpexecuteActionGoal;
