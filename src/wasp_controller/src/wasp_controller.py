...
#roboclaw = Roboclaw(portJackandCant, 115200)
...
#data logging
#file_ = open("/home/wasp2/Desktop/speed.txt", "w")
file1 = open("/home/wasp1/Desktop/velocities.txt", "a")
file2 = open("/home/wasp1/Desktop/pose.txt", "a")
file3 = open("/home/wasp1/Desktop/command_vel.txt", "a")
file4 = open("/home/wasp1/Desktop/cmd_vel.txt", "w")
...
class WaspController(object):
	...
	def __init__(self):
		...
		rospy.Subscriber("command_velocity", Twist, self.loop1)
	...
	def forwardKinematics(self):
		ydot=(self.ydot+self.ydot1)
		xdot=-(self.xdot+self.xdot1)
		thetadot=(self.thetadot+self.thetadot1)        
	...
	def loop1(self,msg):
            ...
            #self.pause()
            self.xdot1 = msg.linear.x
            self.ydot1 = msg.linear.y
            self.thetadot1 = -msg.angular.z
